...
DATABASES = {
    'default': {
        ...
        'HOST': 'sumeyye-django.cmcmxv75bybv.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'sumeyye-blog-django' # please enter your s3 bucket name
