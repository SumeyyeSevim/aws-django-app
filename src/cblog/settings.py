...
DATABASES = {
    'default': {
        ...
        'HOST': 'django-rds.cmcmxv75bybv.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'django-blog-s3bucket-sumeyye' # please enter your s3 bucket name
